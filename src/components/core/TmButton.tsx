...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-xl text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ",
  {
    variants: {
      variant: {
        primary: "bg-tm-Primary-8 text-white",
        secondary:
          "bg-tm-Primary-1 text-tm-Primary-8 border border-tm-Primary-8 hover:bg-tm-Neutral-2",
      },
      size: {
...
const TmButton = React.forwardRef<HTMLButtonElement, ButtonProps>(
...
TmButton.displayName = "Button"

export { TmButton, buttonVariants }
